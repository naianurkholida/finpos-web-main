...
const services_data = [
  ...
  },
  {
    ...
    text_1:'Langganan website kami dirancang untuk memenuhi kebutuhan konten Anda, menyediakan pengalaman online yang lebih baik, dan memberikan nilai tambah yang berkelanjutan. Bergabunglah dengan komunitas langganan kami dan nikmati manfaat eksklusif sekarang!',
    home_2:true,
    service_p_3:true,
  },
  {
  ...
  // home four
  {
    ...
    duration:'.3s',
    delay:'.5s',
    img:'/assets/img/service/face-smile-regular.svg',
    title:'Data Konsumen 100% Menjadi Milik Anda.',
    border_effect:'',
    text_1:'At Collax we specialize in designing, building, shipping and scaling beautiful, usable products with blazing-fast',
    home_4:true,
    service_p:true,
  },
  {
    ...
    duration:'.5s',
    delay:'.7s',
    img:'/assets/img/service/star-solid.svg',
    title:'White Label Produk',
  ...
  },
  {
    ...
    duration:'.7s',
    delay:'.9s',
    img:'/assets/img/service/jempol-solid.svg',
    title:'Free Support Konten dan IT',
  ...
  },
  {
    ...
    duration:'.9s',
    delay:'1s',
    img:'/assets/img/service/obeng-solid.svg',
    title:'Customezeable',
